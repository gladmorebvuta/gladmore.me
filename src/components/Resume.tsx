        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="mb-6 pb-6 border-b border-white/10">
            ...
            <p className="font-mono text-green-400 tracking-wider mb-4" style={{ fontSize: '11px' }}>
              LEAD BRAND ARCHITECT & TECHNOLOGIST
            </p>
          ...
          <div className="mb-6 pb-6 border-b border-white/10">
            ...
            <p className="font-sans text-white leading-relaxed" style={{ fontSize: '10px', lineHeight: '1.6' }}>
              A highly creative and strategic Brand Architect and Product Designer with extensive freelance experience and a passion for building resilient, scalable brand systems. My work is guided by a core philosophy of 'Intelligent Construction'—a holistic methodology focused on integrating brand narrative and user experience into a single, cohesive whole.
            </p>
          </div>
              ...
              <div className="space-y-2">
                <div className="flex gap-2">
                  ...
                  <p className="font-sans text-white" style={{ fontSize: '9px', lineHeight: '1.5' }}>
                    Acted as lead designer and strategist for a diverse portfolio of international clients (Dubai, SA, Kenya, Japan, Zimbabwe).
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="font-mono text-cyan-400 flex-shrink-0" style={{ fontSize: '10px' }}>›</span>
                  <p className="font-sans text-white" style={{ fontSize: '9px', lineHeight: '1.5' }}>
                    Architected and implemented complete company brand systems (Logo, Type, Guidelines).
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="font-mono text-cyan-400 flex-shrink-0" style={{ fontSize: '10px' }}>›</span>
                  <p className="font-sans text-white" style={{ fontSize: '9px', lineHeight: '1.5' }}>
                    Led UI/UX product design for web applications, ensuring premium digital experiences.
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="font-mono text-cyan-400 flex-shrink-0" style={{ fontSize: '10px' }}>›</span>
                  <p className="font-sans text-white" style={{ fontSize: '9px', lineHeight: '1.5' }}>
                    Executed hands-on graphic design for marketing, merchandise, and print collateral.
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="font-mono text-cyan-400 flex-shrink-0" style={{ fontSize: '10px' }}>›</span>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded p-3 backdrop-blur-sm hover:border-cyan-400/50 transition-colors duration-300">
                ...
                <div className="space-y-1">
                  {['Brand Strategy', 'Art Direction', 'UI/UX', 'Design Systems', 'Typography'].map((skill) => (
              ...
              <div className="bg-white/5 border border-white/10 rounded p-3 backdrop-blur-sm hover:border-cyan-400/50 transition-colors duration-300">
                ...
                <div className="space-y-1">
                  {['Figma', 'Photoshop', 'Illustrator', 'React (Conceptual)', 'TypeScript (Conceptual)'].map((skill) => (
                    <div key={skill} className="flex items-center gap-1">
